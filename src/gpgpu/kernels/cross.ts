...
export class CrossPairKernel {
  ...
  private readonly qcap: GPUBuffer;
  private posA: GPUBuffer | null = null;
  private posB: GPUBuffer | null = null;
  ...
  upload(
    ...
    if (!this.bind && this.posA && this.posB && this.pairCount && this.pairs) {
